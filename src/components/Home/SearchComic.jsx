    ...
    return (
        <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-12">
            ...
            <div className="relative mb-10">
                <div className="absolute inset-0 bg-gradient-to-r from-blue-900/20 via-slate-800/20 to-gray-900/20 blur-3xl -z-10"></div>

                <div className="text-center mb-8">
                    <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold bg-gradient-to-r from-blue-600 via-cyan-400 to-blue-500 bg-clip-text text-transparent mb-4 drop-shadow-lg">
                        Komikcast
                    </h1>
                    <p className="text-cyan-400 text-lg">Baca Komik Online Tanpa Iklan Bahasa Indonesia</p>
                </div>

                {/* Modern Search Box */}
                <div className="relative max-w-3xl mx-auto">
                    <div className="relative group">
                        <div className="absolute -inset-0.5 bg-gradient-to-r from-blue-800 to-teal-500 rounded-2xl blur opacity-30 group-hover:opacity-50 transition duration-300"></div>
                        <div className="relative flex items-center bg-white dark:bg-gray-800 rounded-2xl shadow-2xl border border-gray-300 dark:border-gray-700 overflow-hidden">
                            ...
                            {loading && (
                                <div className="px-6">
                                    <svg className="animate-spin h-6 w-6 text-blue-800" fill="none" viewBox="0 0 24 24">
                ...
                <div className="mt-12">
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-4 md:gap-6">
                        {searchResults.map((comic, index) => (
                            <div
                                key={comic.title}
                                className="group relative bg-white/80 dark:bg-gradient-to-b dark:from-gray-800 dark:to-gray-900 backdrop-blur-sm rounded-xl overflow-hidden border border-gray-300 dark:border-gray-700 hover:border-blue-800/50 transition-all duration-300 hover:shadow-2xl hover:shadow-blue-900/20 hover:-translate-y-2"
                            ...
                            >
                                <div className="relative aspect-[2/3] overflow-hidden">
                                    ...
                                    <div className="absolute top-2 right-2 bg-gradient-to-r from-blue-800 to-teal-500 text-white px-3 py-1 rounded-full text-xs font-semibold shadow-lg">
                                        {comic.type}
                                    </div>
                                </div>

                                <div className="p-4">
                                    <h3 className="font-bold text-sm md:text-base line-clamp-2 mb-2 text-gray-900 dark:text-gray-100 group-hover:text-teal-400 dark:group-hover:text-blue-400 transition-colors">
                                        {comic.title}
                                    </h3>
                                    <p className="text-xs text-gray-600 dark:text-gray-400 mb-3 line-clamp-1">{comic.genre}</p>
                                    <button
                                        onClick={() => handleComicDetail(comic)}
                                        className="w-full bg-gradient-to-r from-blue-800 to-teal-500 text-white py-2 rounded-lg hover:from-blue-700 hover:to-slate-800 transition-all duration-300 text-sm font-semibold shadow-lg hover:shadow-teal-500/50"
                                    >
                                        Lihat Detail
                                    </button>
                                </div>
