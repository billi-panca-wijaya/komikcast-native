        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <div className="mb-8 flex flex-col md:flex-row gap-4">
                ...
                <div className="relative flex-1 max-w-2xl">
                    ...
                    <input
                        ...
                        placeholder="Cari komik di pustaka..."
                        className="w-full pl-12 pr-4 py-4 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm border border-gray-300 dark:border-gray-700 rounded-2xl text-gray-900 dark:text-gray-100 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-300 shadow-lg hover:shadow-xl"
                    />
                    {searchQuery && (
                        <button
                ...
                <div className="flex items-center gap-2">
                    ...
                    <select
                        ...
                        className="px-4 py-3 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm border border-gray-300 dark:border-gray-700 rounded-xl text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500 cursor-pointer shadow-lg"
                    >
            ...
            {(searchQuery || activeGenre) && (
                <div className="mb-4 flex flex-wrap items-center gap-2">
                    ...
                    {searchQuery && (
                        <span className="px-3 py-1 bg-blue-500/20 text-teal-400 text-sm rounded-full flex items-center gap-1">
            ...
            <div className="flex flex-col lg:flex-row gap-8">
                                ...
                                {sortedComics.map((comic, index) => (
                                    ...
                                    >
                                        <div className="relative aspect-[2/3] overflow-hidden">
                                            ...
                                            <div className="absolute top-2 right-2 bg-gradient-to-r from-blue-700 to-teal-500 text-white px-3 py-1 rounded-full text-xs font-semibold shadow-lg">
                                                Ch. {comic.chapter}
                                            </div>
                                        ...
                                        <div className="p-4">
                                            <h3 className="font-bold text-sm md:text-base line-clamp-2 mb-3 text-gray-900 dark:text-gray-100 group-hover:text-teal-500 dark:group-hover:text-teal-400 transition-colors min-h-[2.5rem]">
                                                {comic.title}
                                            </h3>
                                            <button
                                                onClick={() => handleComicDetail(comic)}
                                                className="w-full bg-gradient-to-r from-blue-700 to-teal-500 text-white py-2 rounded-lg hover:from-blue-500 hover:to-cyan-500 transition-all duration-300 text-sm font-semibold shadow-lg hover:shadow-teal-500/50 flex items-center justify-center gap-2"
                                            >
                ...
                {/* Sidebar */}
                {sidebarComics.length > 0 && !loading && (
                    <div className="lg:w-80 xl:w-96">
                        <div className="sticky top-24">
                            {/* Sidebar Header */}
                            <div className="relative mb-6 p-4 bg-gradient-to-r from-blue-600/20 via-cyan-600/20 to-teal-600/20 rounded-2xl border border-teal-500/30 overflow-hidden">
                                <div className="absolute inset-0 bg-gradient-to-r from-blue-600/10 to-cyan-600/10 animate-pulse"></div>
                                <div className="relative flex items-center gap-3">
                                    <div className="p-3 bg-gradient-to-br from-blue-500 to-cyan-600 rounded-xl shadow-lg animate-bounce">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-400">Komik pilihan dari pustaka</p>
                                    </div>
                                </div>
                                ...
                                {sidebarComics.slice(0, 5).map((comic, index) => (
                                    <div
                                        ...
                                        className={`group relative flex gap-4 p-3 rounded-xl border transition-all duration-500 cursor-pointer overflow-hidden ${
                                            hoveredSidebar === index 
                                                ? 'bg-gradient-to-r from-blue-600/20 to-cyan-600/20 border-teal-500/50 scale-105 shadow-xl shadow-teal-500/20' 
                                    ...
                                    >
                                        ...
                                        <div className="flex-1 min-w-0">
                                            ...
                                            <span className="px-2 py-0.5 bg-blue-500/20 text-teal-400 text-xs rounded-full">
                                                Ch. {comic.chapter}
                                            </span>
                                        </div>
                                    </div>
